                    ...
                    <div class="col-md-8 col-md-push-2">
                        ...
                        <form action="<?= base_url('wedding/index'); ?>" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label>Makanan Kesukaan*</label>
                                    <input type="text" name="makes" id="makes" class="form-control form-opacity">
                                </div>
                                <div class="col-md-12">
    ...
    <section class="gla_section gla_image_bck" data-color="#fff">
        ...
        <div class="container text-center">
            ...
            <div class="button-group filter-button-group">
                ...
                <a data-filter=".groomsmen">Pihak Laki-Laki</a>
                <a data-filter=".bridesmaids">Pihak Perempuan</a>
            </div>
            <!-- filters end -->
