<!-- Slider -->
<div class="gla_slider gla_image_bck  gla_wht_txt gla_fixed" data-image="<?= base_url('wedding-2/'); ?>images/wedding/carita_lee/15319475049_fc467e5874_k.jpg" data-stellar-background-ratio="0.4">
    ...
    <div class="container">
        ...
        <div class="gla_slide_txt gla_slide_center_bottom text-center">
            <p><img src="<?= base_url('wedding-2/'); ?>images/badge.png" alt="" height="350"></p>
...
<section id="gla_content" class="gla_content">
        ...
        <div class="container text-center">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-4 gla_round_block">
                    <div class="gla_round_im gla_image_bck" data-image="<?= base_url('wedding-2/'); ?>images/wedding/carita_lee/600x600/15503304111_d927414239_k.jpg"></div>
                    <h3>Carita Kimball</h3>
                </div>
                <div class="col-md-4 gla_round_block">
                    <p><img src="<?= base_url('wedding-2/'); ?>images/animations/mrandmrs.gif" data-bottom-top="@src:images/animations/mrandmrs.gif" height="150" alt=""></p>
                ...
                <div class="col-md-4 gla_round_block">
                    <div class="gla_round_im gla_image_bck" data-image="<?= base_url('wedding-2/'); ?>images/wedding/carita_lee/600x600/15319460687_17d6396bac_k.jpg"></div>
                    <h3>Lee Guarino</h3>
                </div>
            </div>
    ...
    <section class="gla_section gla_image_bck" data-color="#ecf2f0">
        ...
        <div class="container">
            <div class="row gla_auto_height">
                ...
                <div class="col-md-6 gla_image_bck" data-image="<?= base_url('wedding-2/'); ?>images/wedding/carita_lee/15499990315_b11d1e7c7f_k.jpg">
                ...
                <div class="col-md-6 col-md-pull-6 gla_image_bck" data-image="<?= base_url('wedding-2/'); ?>images/wedding/carita_lee/15319753278_2c5a50cb74_k.jpg">
        ...
        <div class="container text-center">
            ...
            <div class="gla_icon_boxes row text-left">
                ...
                <div class="col-md-6 col-sm-6">
                    <a href="#" class="gla_news_block">
                        <span class="gla_news_img">
                            <span class="gla_over" data-image="<?= base_url('wedding-2/'); ?>images/wedding_m/600x600/tom-pumford-226386.jpg"></span>
                        </span>
                ...
                <div class="col-md-6 col-sm-6">
                    <a href="#" class="gla_news_block">
                        <span class="gla_news_img">
                            <span class="gla_over" data-image="<?= base_url('wedding-2/'); ?>images/wedding_m/600x600/tamara-menzi-224980.jpg"></span>
                        </span>
        ...
        <div class="container text-center">
            ...
            <div class="gla_icon_boxes gla_partners row">
                ...
                <div class="gla_partner_box">
                    <a href="#"><img src="<?= base_url('wedding-2/'); ?>images/partners/macys-logo_bl.png" height="80" alt=""></a>
                </div>

                <!-- item -->
                <div class="gla_partner_box">
                    <a href="#"><img src="<?= base_url('wedding-2/'); ?>images/partners/amazon_bl.png" height="80" alt=""></a>
                </div>

                <!-- item -->
                <div class="gla_partner_box">
                    <a href="#"><img src="<?= base_url('wedding-2/'); ?>images/partners/bed-bath-beyond-logo_bl.png" height="80" alt=""></a>
                </div>

                <!-- item -->
                <div class="gla_partner_box">
                    <a href="#"><img src="<?= base_url('wedding-2/'); ?>images/partners/crate_bl.png" height="80" alt=""></a>
                </div>

                <!-- item -->
                <div class="gla_partner_box">
                    <a href="#"><img src="<?= base_url('wedding-2/'); ?>images/partners/newly_bl.png" height="80" alt=""></a>
                </div>
    ...
    <!-- section -->
    <section class="gla_section gla_image_bck gla_wht_txt gla_fixed" data-stellar-background-ratio="0.8" data-image="<?= base_url('wedding-2/'); ?>images/wedding/carita_lee/15320532559_ee3e0d021d_k.jpg">
        ...
        <div class="container text-center">
            ...
            <div class="row text-center">
                <div class="col-md-3 gla_round_block">
                    <div class="gla_round_im gla_image_bck" data-image="<?= base_url('wedding-2/'); ?>images/wedding/carita_lee/600x600/15319753278_2c5a50cb74_k.jpg"></div>
                    <h4>Jessica Robbinson</h4>
                </div>
                <div class="col-md-3 gla_round_block">
                    <div class="gla_round_im gla_image_bck" data-image="<?= base_url('wedding-2/'); ?>images/wedding/carita_lee/600x600/15319361997_c1640fa738_k.jpg"></div>
                    <h4>Ronald Down</h4>
                </div>
                <div class="col-md-3 gla_round_block">
                    <div class="gla_round_im gla_image_bck" data-image="<?= base_url('wedding-2/'); ?>images/wedding/carita_lee/600x600/15499035192_2d5a8a1e2e_k.jpg"></div>
                    <h4>Marry Clay</h4>
                </div>
                <div class="col-md-3 gla_round_block">
                    <div class="gla_round_im gla_image_bck" data-image="<?= base_url('wedding-2/'); ?>images/wedding/carita_lee/600x600/15496676321_adf8baee9e_k.jpg"></div>
    ...
    <!-- section -->
    <section class="gla_section gla_image_bck gla_fixed gla_wht_txt" data-stellar-background-ratio="0.8" data-image="<?= base_url('wedding-2/'); ?>images/wedding/carita_lee/15502403291_7acc15ad4f_k.jpg">
