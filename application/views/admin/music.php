            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card shadow mb-4">
                    ...
                    <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                        <h6 class="m-0 font-weight-bold text-primary"><?= $mc['nama']; ?></h6>
                    </a>
                    ...
                    <div class="collapse" id="collapseCardExample">
                        ...
                        <div class="card-body border-bottom-primary">
                            ...
                            <p class="mb-4"><?= $mc['nama']; ?> </p>

                            <label class="font-weight-bold" for="id_music">ID Music</label>
                            <p class="mb-4"><?= $mc['id_music']; ?> </p>

                            <a class="btn btn-sm btn-primary" href=" <?= base_url('admin/edit_music/') . $mc['id']; ?>"><i class="fas fa-edit"></i> Edit</a>
                            <a class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin');" href=" <?= base_url('admin/delete_music/') . $mc['id']; ?>"><i class="fas fa-trash-alt"></i>Delete</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="tambahmusicModal" tabindex="-1" aria-labelledby="tambahmusicModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/music'); ?>" method="POST" enctype="multipart/form-data">
