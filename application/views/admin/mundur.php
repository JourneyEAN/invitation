                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="collapse" id="collapseCardExample">
                        ...
                        <div class="card-body border-bottom-primary">
                            ...
                            <a class="btn btn-sm btn-primary" href=" <?= base_url('admin/edit_mundur/') . $hm['id']; ?>"><i class="fas fa-edit"></i> Edit</a>
                            <a class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin');" href=" <?= base_url('admin/delete_mundur/') . $hm['id']; ?>"><i class="fas fa-trash-alt"></i>Delete</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="tambahmundurModal" tabindex="-1" aria-labelledby="tambahmundurModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/mundur'); ?>" method="POST" enctype="multipart/form-data">
