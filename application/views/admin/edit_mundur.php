<div class="row">
    <div class="col-lg-10">
        <div class="p-5">
            ...
            <form method="POST" action="<?= base_url('admin/edit_mundur/') . $hitung_mundur['id']; ?>" enctype="multipart/form-data">
                ...
                <a class="btn btn-sm btn-info text-decoration-none" href="<?= base_url('admin/mundur') ?>"> Kembali</a>
